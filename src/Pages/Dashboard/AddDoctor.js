...
const AddDoctor = () => {
    ...
    const { data: services, isLoading } = useQuery('services', () => fetch('https://serene-falls-35288.herokuapp.com/service').then(res => res.json()))
        ...
        fetch(url, {
            ...
            .then(result => {
                if (result.success) {
                    ...
                    fetch('https://serene-falls-35288.herokuapp.com/doctor', {
                        method: 'POST',
                        headers: {
